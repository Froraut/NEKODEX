...
**当前下载版本：** `5.9.0-nekodex.4`，适用于 macOS 13 或更高版本。

| Mac 类型 | 下载 |
| --- | --- |
| Apple Silicon（M1 及更新型号） | [ARM64 DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.9.0-nekodex.4/NEKODEX-5.9.0-nekodex.4-mac-arm64.dmg) |
| Intel | [Intel DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.9.0-nekodex.4/NEKODEX-5.9.0-nekodex.4-mac-x64.dmg) |

[发行页面](https://github.com/Froraut/NEKODEX/releases/tag/v5.9.0-nekodex.4) · [校验和](https://github.com/Froraut/NEKODEX/releases/download/v5.9.0-nekodex.4/checksums.txt)。本次发行提供 macOS 和 Linux x64 安装包；未签名的 Windows 预览包单独提供。
