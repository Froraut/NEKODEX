...
**ダウンロード版：** `6.0.0-nekodex.1`。macOS 13 以降に対応しています。

| Mac | ダウンロード |
| --- | --- |
| Apple Silicon（M1 以降） | [ARM64 DMG](https://github.com/Froraut/NEKODEX/releases/download/v6.0.0-nekodex.1/NEKODEX-6.0.0-nekodex.1-mac-arm64.dmg) |
| Intel | [Intel DMG](https://github.com/Froraut/NEKODEX/releases/download/v6.0.0-nekodex.1/NEKODEX-6.0.0-nekodex.1-mac-x64.dmg) |

[リリースページ](https://github.com/Froraut/NEKODEX/releases/tag/v6.0.0-nekodex.1) · [チェックサム](https://github.com/Froraut/NEKODEX/releases/download/v6.0.0-nekodex.1/checksums.txt)。macOS と Linux x64 に対応しています。未署名の Windows プレビューは別途提供します。
