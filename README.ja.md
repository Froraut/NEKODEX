...
**ダウンロード版：** `5.2.0-nekodex.9`。macOS 13 以降に対応しています。

| Mac | ダウンロード |
| --- | --- |
| Apple Silicon（M1 以降） | [ARM64 DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.9/NEKODEX-5.2.0-nekodex.9-mac-arm64.dmg) |
| Intel | [Intel DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.9/NEKODEX-5.2.0-nekodex.9-mac-x64.dmg) |

[リリースページ](https://github.com/Froraut/NEKODEX/releases/tag/v5.2.0-nekodex.9) · [チェックサム](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.9/checksums.txt)。このリリースは macOS 版のみです。
