...
**ダウンロード版：** `5.2.0-nekodex.8`。macOS 13 以降に対応しています。

| Mac | ダウンロード |
| --- | --- |
| Apple Silicon（M1 以降） | [ARM64 DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.8/NEKODEX-5.2.0-nekodex.8-mac-arm64.dmg) |
| Intel | [Intel DMG](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.8/NEKODEX-5.2.0-nekodex.8-mac-x64.dmg) |

[リリースページ](https://github.com/Froraut/NEKODEX/releases/tag/v5.2.0-nekodex.8) · [チェックサム](https://github.com/Froraut/NEKODEX/releases/download/v5.2.0-nekodex.8/checksums.txt)。このリリースは macOS 版のみです。
