...
const en = {
  ...
  passkeyImportingBody: "Checking the Chrome sign-in and importing it into the launcher's private browser. Keep the Chrome window open until this finishes.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  passkeyImportingBody: "正在检查 Chrome 登录并将其导入启动器的私有浏览器。完成前请保持 Chrome 窗口打开。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  passkeyImportingBody: "Chrome のログインを確認し、ランチャー専用のブラウザーに取り込んでいます。完了するまで Chrome ウィンドウを開いたままにしてください。",
