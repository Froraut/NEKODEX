...
const copy: Record<Language, BrowserWindowCopy> = {
  en: {
    ...
    saveFailed: "Workspace restoration state could not be saved. Open windows are unaffected.",
  ...
  ru: {
    ...
    saveFailed: "Не удалось сохранить восстановление окон. Открытые окна продолжают работать.",
  ...
  "zh-CN": {
    ...
    saveFailed: "无法保存工作区恢复状态。已打开的窗口不受影响。",
  ...
  "zh-TW": {
    ...
    saveFailed: "無法儲存工作區還原狀態。已開啟的視窗不受影響。",
  ...
  ja: {
    ...
    saveFailed: "ワークスペースの復元状態を保存できませんでした。開いているウインドウには影響しません。",
  ...
  ko: {
    ...
    saveFailed: "작업 공간 복원 상태를 저장하지 못했습니다. 열린 창은 계속 작동합니다.",
