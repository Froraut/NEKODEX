...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  closeBrowserTab: (tabId, expectedTraceId) => ipcRenderer.invoke("launcher:browser-tab-close", tabId, expectedTraceId),
  dismissTask: (accountId, id) => ipcRenderer.invoke('launcher:task-dismiss', accountId, id),
  queueAction: (id, action) => ipcRenderer.invoke('launcher:queue-action', id, action),
  pauseQueue: (accountId, paused) => ipcRenderer.invoke('launcher:queue-pause', accountId, paused),
  ...
  refreshAccountAuthentication: id => ipcRenderer.invoke("launcher:account-authentication-refresh", id),
  accountCodexQuotaSnapshot: id => ipcRenderer.invoke("launcher:account-codex-quota-snapshot", id),
  refreshAccountCodexQuota: id => ipcRenderer.invoke("launcher:account-codex-quota-refresh", id),
  refreshAccountCodexQuotas: () => ipcRenderer.invoke("launcher:account-codex-quotas-refresh"),
  codexLoginSnapshot: () => ipcRenderer.invoke("launcher:codex-login-snapshot"),
  startCodexLogin: id => ipcRenderer.invoke("launcher:codex-login-start", id),
  codexLoginStatus: (flowId, id) => ipcRenderer.invoke("launcher:codex-login-status", flowId, id),
  openCodexLogin: (flowId, id) => ipcRenderer.invoke("launcher:codex-login-open", flowId, id),
  cancelCodexLogin: (flowId, id) => ipcRenderer.invoke("launcher:codex-login-cancel", flowId, id),
  copyCodexLoginCode: (flowId, id) => ipcRenderer.invoke("launcher:codex-login-copy-code", flowId, id),
  ...
  repairWebRoute: () => ipcRenderer.invoke("launcher:repair-web-route"),
  ...
  cancelUpdatePreparation: () => ipcRenderer.invoke("launcher:update-cancel"),
  ...
  onLifecycle: (listener) => subscription("launcher:lifecycle", listener),
