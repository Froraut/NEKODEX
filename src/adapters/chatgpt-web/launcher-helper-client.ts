...
import { notifyLauncherTurn } from "../../launcher-browser-control";
import { readLauncherBrowserHostDescriptor } from "../../launcher-browser-descriptor";
...
export class LauncherBrowserHelperClient {
  ...
  private handleLine(child: ChildProcessWithoutNullStreams, line: string): void {
    ...
    let message: HelperTurnOutputMessage;
