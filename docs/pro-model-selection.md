...
The following sanitized accessibility observations were reported by JulianZJN in
[upstream PR #439](https://github.com/miuuyy/codex-chatgpt-web/pull/439), commit
`039c385f09ba43eac398259eb6360ffe02ede75e`, on 2026-09-11 from an authenticated
ChatGPT model picker. They are upstream evidence, not a new account observation by this fork:
...
The upstream isolated DEV run also captured this DOM structure after selecting 5.6 (classes omitted and
...
authentication guards when integrating the feature. No live account operation was performed
