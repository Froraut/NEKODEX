...
Локальный ключ заменён, Codex Native3 создан и подключён. Проверка в установленном приложении подтвердила доступность коннектора. Это ещё не доказательство выполнения инструмента: для него подготовлен отдельный небольшой сценарий Hermes.
